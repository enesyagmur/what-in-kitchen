...
const Ai = () => {
  ...
  return (
    <div className="w-full lg:w-11/12 h-screen lg:h-[600px] relative flex items-center justify-center">
      ...
      <div
        ...
        } w-full  lg:w-11/12 bg-green_custom z-10 flex flex-col items-center justify-center `}
      >
        {list.length ? (
          <Materials list={list} />
        ) : (
